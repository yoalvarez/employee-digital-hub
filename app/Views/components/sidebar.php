...
<aside class="fixed top-0 left-0 h-screen w-64 bg-white shadow-lg z-20 flex flex-col">
    <div class="p-4 flex-1 overflow-y-auto">
        <a href="<?= base_url('/') ?>" class="text-2xl font-bold mb-6 inline-block">EDH</a>
        <nav>
            <ul>
                ...
                ?>
                <li class="mb-2">
                    <a href="<?= base_url($menu['url']) ?>" class="flex items-center gap-3 px-4 py-2 rounded-lg <?= $isActive ? 'bg-primary text-primary-content' : 'hover:bg-base-200' ?>">
                        <?= $menu['icon'] ?>
